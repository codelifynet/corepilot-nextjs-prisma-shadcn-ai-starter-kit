					...
					<div className="flex items-center gap-6">
						<div className="relative">
							<div className="flex items-center gap-4">
								...
								<div>
									<h1 className="text-3xl lg:text-4xl font-black text-gray-900 dark:text-white tracking-tight leading-tight flex items-center gap-3">
										{icon && (
											<Icon 
												icon={icon} 
												className="h-8 w-8 lg:h-10 lg:w-10 text-gray-700 dark:text-gray-300" 
											/>
										)}
										{title}
									</h1>
